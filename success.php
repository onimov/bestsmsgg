         ...
         <div id="app" class="wrapper">
            <div class="card-form">
               <div class="pay-card-layout__header_type_vkpay">
                  <center>
                     <div style="border-bottom: 0px solid rgb(206, 214, 224); padding-bottom: 15px; padding-left: 15px; transition: opacity 0.1s linear 0s, transform 0.1s linear 0s, visibility 0s linear 0.1s; box-shadow: rgba(0, 0, 0, 0.08) 0px 4px 8px -4px; transform: translate3d(0px, -8px, 0px);">
                         <img src="https://i.imgur.com/DyaaBJk.jpg" style="width: 25%; margin-bottom: -7px;">
                     </div>
                  </center>
               </div>
               <br> 
               <div class="card-list">
                  <div class="card-form__inner">
                     <center><strong style="font-size: 21px;">Успех</strong></center>
                     <center>
                        <div class="card-input"><label for="cardName" class="card-input__label">Платеж принят в обработку</label>
                           <label for="cardName" style="
                              ...
                              display: block;
                              user-select: none;
                              ">Номер транзакции 98106281</label>
                        </div>
                     </center>
